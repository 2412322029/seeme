import{a as r,aH as w,b as P,j as E,u as S,o as x,q as T,h as k,ah as I,aI as N,a2 as C,aJ as R,z as A,aK as y}from"./index-C-2t4lpF.js";import{u as q}from"./use-houdini-Bd_Chwmg.js";const{cubicBezierEaseInOut:t,cubicBezierEaseOut:D,cubicBezierEaseIn:H}=w;function G({overflow:a="hidden",duration:n=".3s",originalTransition:i="",leavingDelay:e="0s",foldPadding:o=!1,enterToProps:s,leaveToProps:p,reverse:l=!1}={}){const d=l?"leave":"enter",c=l?"enter":"leave";return[r(`&.fade-in-height-expand-transition-${c}-from,
